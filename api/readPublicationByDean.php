...
$accRights=array('dean', 'admin', 'a&p_sub_comm');
...
$resultFaculty = $conn->executeQuery("$dbname.$staffProfile", $queryDriver)->toArray();

if (count($resultFaculty) > 0) {
    $faculty = $resultFaculty[0]->registry->faculty;
}

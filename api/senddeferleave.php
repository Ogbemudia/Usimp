...
function    defermentOfAnnualLeave($mailSend, $mailS, $mailB, $fromName, $bursaryNo1, $date1, $title, $surname, $first_name, $dept, $leaveDay, $leaveMonth, $year, $nextYear, $noLeaveDays, $endDate, $resumptionDate, $signature, $fullName, $designation){
